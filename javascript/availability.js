const statusBadge = document.getElementById("statusBadge"); // Asegúrate de que este ID exista en tu HTML
const changeStatus = document.getElementById("changeStatus"); // Asegúrate de que este ID exista en tu HTML
